  ...
  const queue = useMemo(() => {
    ...
    return SC.RECORDS
      ...
      .map((r) => {
        ...
        // thing in this queue: a real person is waiting, identified. An earlier
        // version scored only "bekliyor", so approving a claim DROPPED the
        // record's priority — exactly backwards.
