...
// The prototype lives in the repo, under the design handoff bundle, so this
// check has teeth in CI as well as locally: it compares the shipped engine
// against the exact artefact Claude Design delivered.
const PROTO = "../design/project";
